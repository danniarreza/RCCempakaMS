...
class Product_Model extends CI_Model
{
    ...
    public function insertNewProduct($params_table, $params_columns, $params_conditions)
    {
        $columns = '';
        $values = '';
    ...
    public function updateProduct($params_table, $params_columns, $params_conditions)
    {
    ...
    public function getProductByColumn($params_table, $params_columns, $params_conditions)
    {
        $query = "SELECT ";
    ...
    public function getProductByColumnJoin($params_table, $params_columns, $params_conditions, $params_join)
    {
        $select = '';
        for ($i=0; $i < count($params_columns) ; $i++) {
    ...
    public function getProductByColumnJoinLimit($params_table, $params_columns, $params_conditions, $params_join, $params_limit)
    {
        $select = '';
        for ($i=0; $i < count($params_columns) ; $i++) {
            $select = ($i == count($params_columns)-1) ? $select . strtoupper($params_columns[$i]).' ' : $select . strtoupper($params_columns[$i]).', ';
    ...
    public function getProductById($params_table, $params_columns, $params_conditions)
    {
        $query = "SELECT ";
    ...
    public function getProductOrderByLimit($params_table, $params_columns, $params_conditions, $params_orderby, $params_limit)
    {
        $select = '';
        for ($i=0; $i < count($params_columns) ; $i++) {
            $select = ($i == count($params_columns)-1) ? $select . strtoupper($params_columns[$i]).' ' : $select . strtoupper($params_columns[$i]).', ';
    ...
    public function getProductOrderByColumnJoinLimit($params_table, $params_columns, $params_conditions, $params_orderby, $params_join, $params_limit)
    {
        $select = '';
        for ($i=0; $i < count($params_columns) ; $i++) {
            $select = ($i == count($params_columns)-1) ? $select . strtoupper($params_columns[$i]).' ' : $select . strtoupper($params_columns[$i]).', ';
