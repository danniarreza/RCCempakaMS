...
class User_Model extends CI_Model
{
    ...
    public function insertNewUser($params_table, $params_columns, $params_conditions)
    {
        $columns = '';
        $values = '';
    ...
    public function updateUser($params_table, $params_columns, $params_conditions)
    {
    ...
    public function getUserByColumn($params_table, $params_columns, $params_conditions)
    {
        $query = "SELECT ";
    ...
    public function getUserById($params_table, $params_columns, $params_conditions)
    {
        $query = "SELECT ";
    ...
    public function getUserByColumnJoin($params_table, $params_columns, $params_conditions, $params_join)
    {
        $select = '';
        for ($i=0; $i < count($params_columns) ; $i++) {
