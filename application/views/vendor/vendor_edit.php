  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <ol class="breadcrumb">
              ...
              <li><a href="<?php echo site_url('Vendor/')?>">Daftar Vendor</a></li>
              <li class="active">Edit Detail Vendor</li>
          </ol>
      </section>
      ...
      <section class="content">
          ...
          <div class="box box-success">
              <div class="box-header with-border">
                  ...
                  <!-- <h3 class="box-title"><?php echo $vendorslist[0]['NAME_VENDOR']?></h3> -->
              ...
              <!-- /.box-header -->
              <form role="form"
                  action="<?php echo site_url('Vendor/vendorEditHandler/'.$vendorslist[0]['ID_VENDOR']);?>"
                  method="post" enctype="multipart/form-data" onsubmit="return edit_vendor_validation();">
                  <div class="box-body">
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input disabled type="text" class="form-control" id="id" style="border-radius: 4px"
                                      placeholder="Kode Vendor..." name="id"
                                      value="<?php echo $vendorslist[0]['ID_VENDOR']?>">
                              </div>
                              <div class="form-group" id="name_form_group">
                                  ...
                                  <input type="text" class="form-control" id="name" style="border-radius: 4px"
                                      placeholder="Nama Vendor..." name="name"
                                      value="<?php echo $vendorslist[0]['NAME_VENDOR']?>">
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="form-group" id="type_form_group">
                                  ...
                                  <select class="form-control select2" name="type" id="type" style="width: 100%;">
                                      <option value="STORE"
                                          <?php echo ($vendorslist[0]['TYPE_VENDOR'] == 'STORE') ? 'selected':''?>>
                                          Store</option>
                                      <option value="SUPPLIER"
                                          <?php echo ($vendorslist[0]['TYPE_VENDOR'] == 'SUPPLIER') ? 'selected':''?>>
                                          Supplier</option>
                                  </select>
          ...
          <?php 
          if($vendorslist[0]['TYPE_VENDOR'] == 'STORE'){
              ?>
          <div class="row">
              <!-- left column -->
              <div class="col-md-6">
...
function edit_vendor_validation() {
