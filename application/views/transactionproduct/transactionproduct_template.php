...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        $(function() {
            ...
            $('.select2').select2()
            $('#transactionproductdetailtable').DataTable({
                'responsive': true,
                // 'paging'      : true,
                // 'lengthChange': false,
                // 'searching'   : false,
            ...
            if (document.getElementById('transactiontable') != null) {
                ...
                var currentColumnCounter = 0;
                var tableColumnCount = table.columns()["0"].length;

                $('#transactiontable tfoot th').each(function() {
                    if (currentColumnCounter < tableColumnCount - 2) {
                        $(this).html(
                            '<div class="form-group"><input id="searchbox_' + currentColumnCounter +
                            '" type="text" class="form-control" style="border-radius: 4px" value="" placeholder="Search ..." /></div>'
                        );
                        console.log(currentColumnCounter);
                        currentColumnCounter++;
                    } else if (currentColumnCounter == tableColumnCount - 2) {
                        var title = $(this).text();
                        $(this).html(
                            '<div id="n"></div>'
                        );
                        console.log(currentColumnCounter + ' This is the last index');
                        currentColumnCounter++;
                    }
                });
                ...
                var r = $('#transactiontable tfoot tr');
                r.find('th').each(function() {
                    $(this).css('padding', 8);
                });
                $('#transactiontable thead').append(r);
            ...
            // if (document.getElementById('transactiondate') != null) {
            ...
            if (document.getElementById('customeradd_birthdate') != null) {
                //Entrydate Date picker
                $('#customeradd_birthdate').datepicker({
                    format: 'dd MM yyyy',
                    autoclose: true,
                    changeMonth: true,
                    changeYear: true
