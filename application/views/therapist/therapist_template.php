        ...
        $(function() {
            ...
            if (document.getElementById('transactionproducthistory') != null) {
                ...
                table.columns().every(function() {
                    ...
                    document.getElementById('transactionproducthistory_filter').innerHTML =
                        '<label>Total: </label><label id="transactionproducthistory_totaltransaction" class="form-control input-sm" style="margin-left:8px"></label>';
