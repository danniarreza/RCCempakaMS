                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        <div class="direct-chat-info clearfix">
                                            <span class="direct-chat-name pull-left"><?php echo $this->session->user_name;?></span>
                                ...
                                <ul class="users-list clearfix">
                                    <li>
                                        <img src="<?php echo base_url('assets/dist/img/user1-128x128.jpg');?>"
                                            alt="User Image">
                                        <a class="users-list-name" href="#"><?php echo $this->session->user_name;?></a>
                                    ...
                                    <li>
                                        <img src="<?php echo base_url('assets/dist/img/user7-128x128.jpg');?>"
                                            alt="User Image">
                                        <a class="users-list-name" href="#">Jane</a>
                                        <span class="users-list-date">12 Jan</span>
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url('assets/dist/img/user6-128x128.jpg');?>"
                                            alt="User Image">
                                    ...
                                    <li>
                                        <img src="<?php echo base_url('assets/dist/img/user5-128x128.jpg');?>"
                                            alt="User Image">
                        ...
                        <ul class="products-list product-list-in-box">
                            <li class="item">
                                <div class="product-img">
                                    <img src="<?php echo base_url('assets/dist/img/default-50x50.gif');?>"
                                        alt="Product Image">
                                </div>
