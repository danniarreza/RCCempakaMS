<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <!-- <li <?php echo ($sidebar_active == 'Product'? 'class="active"':'')?>>
            ...
            <li
                <?php echo (isset(explode("_", $sidebar_active)[0]) && explode("_", $sidebar_active)[0] == 'Stock' ? 'class="active treeview"' : 'class="treeview"') ?>>
                <a href="#">
                    <i class="fa fa-book"></i>
                    <span>Stock</span>
                    <span class="pull-right-container">
                    ...
                    <ul class="treeview-menu">
                        <li
                            <?php echo (isset(explode("_", $sidebar_active)[1]) && explode("_", $sidebar_active)[1] == 'History' ? 'class="active"': '')?>>
                            <a href="<?php echo site_url('StockHistory/')?>"><i class="fa fa-circle-o"></i> History</a>
                        </li>
                        <li
                            <?php echo (isset(explode("_", $sidebar_active)[1]) && explode("_", $sidebar_active)[1] == 'Receipt' ? 'class="active"': '')?>>
                            <a href="<?php echo site_url('StockReceipt/')?>"><i class="fa fa-circle-o"></i> Masuk</a>
                        </li>
                        <li
                            <?php echo (isset(explode("_", $sidebar_active)[1]) && explode("_", $sidebar_active)[1] == 'Transfer' ? 'class="active"': '')?>>
                            <a href="<?php echo site_url('StockTransfer/')?>"><i class="fa fa-circle-o"></i>
                                Transfer</a>
                        </li>
                        <li
                            <?php echo (isset(explode("_", $sidebar_active)[1]) && explode("_", $sidebar_active)[1] == 'Expired' ? 'class="active"': '')?>>
                            <a href="<?php echo site_url('StockExpired/')?>"><i class="fa fa-circle-o"></i> Expired</a>
                        </li>
                    </ul>
                </a>
            </li>
            ...
            <?php if($this->session->user_type == 'Super Admin' || $this->session->user_type == 'Admin'){
                ?>
            <li <?php echo ($sidebar_active == 'Therapist'? 'class="active"':'')?>>
