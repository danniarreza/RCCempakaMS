...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        $(function() {
            ...
            if (document.getElementById('transactionproducthistory') != null) {

                $('#transactionproducthistory tfoot th').each(function() {
                    var title = $(this).text();
                    $(this).html(
                        '<div class="form-group"><input type="text" class="form-control" style="border-radius: 4px" placeholder="Search ..." /></div>'
                    );
                ...
                // DataTable
                // var table = $('#example').DataTable();
                var table = $('#transactionproducthistory').DataTable({
                    'responsive': true,
                    'pageLength': 100,
                    'autoWidth': true,
                    "order": [
                ...
                table.columns().every(function() {
                    ...
                    document.getElementById('transactionproducthistory_filter').innerHTML = '<label>Total: </label><label id="transactionproducthistory_totaltransaction" class="form-control input-sm" style="margin-left:8px"></label>';
                    // console.log(document.getElementById('transactionproducthistory_filter'))
                ...
                var r = $('#transactionproducthistory tfoot tr');
                r.find('th').each(function() {
                    $(this).css('padding', 8);
                });
                $('#transactionproducthistory thead').append(r);
                $('#search_0').css('text-align', 'center');

                countTransactionProductTotal();

                $('#transactionproducthistory').on('draw.dt', function() {
                    // alert('Table redrawn');
            ...
            $('#transactiontreatmenthistory').DataTable({
                'responsive': true,
                // 'pageLength': 25,
                'autoWidth': true
            })

            $('#transactiontreatmenthistory').on('draw.dt', function() {
                // alert('Table redrawn');

                countTransactionTreatmentTotal();
            });
